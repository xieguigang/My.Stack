...
自己使用VB除去编写Aspx，Windows应用，hololens AR应用等这类的商业软件开发以外，我觉得还可以做更多的很酷炫的事情上面去，例如VB所原生支持的云计算编程，利用云计算进行数据工业生产，使用VB做动力学系统等等需要非常大的计算量的科研工作，当然也可以用VB从最底层开始写自己的计算机操作系统，然后安装到物理机上面跑，这一类都是能够用VB很好完成的cool things。
