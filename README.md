...
## 心态的变化
都说初生牛犊不怕虎，事实上我在最开始学编程的时候，总是以为自己是最厉害的，心里面会想着怎么能够在一个星期以内完成一个很牛逼的作品。在github上面的这一年的时间，也是自己脱离幼稚，慢慢的沉淀自己，编码技术走向成熟的一个过程。

### 第一步: do cool things that doesn't matter - 做一些无关紧要的事情
最开始每天都要做一些无关紧要的事情，因为Rome was not built in a day.
